...
<!-- Mirrored from cartzilla.createx.studio/shop-catalog-fashion.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 May 2024 18:42:25 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <!-- SEO Meta Tags -->
  <title>Vijayalaxmi sarees</title>
 ...
 <?php include_once './common/topbar.php' ?>
  ...
  <header class="navbar navbar-expand-lg navbar-sticky bg-body d-block z-fixed p-0" data-sticky-navbar="{&quot;offset&quot;: 500}">
    <div class="container py-2 py-lg-3">
      ...
      <!-- Navbar brand (Logo) -->
      <a class="navbar-brand fs-2 py-0 m-0 me-auto me-sm-n5" href="home-fashion-v1.html">Vijayalaxmi sarees</a>
    ...
    <div class="collapse navbar-stuck-hide" id="stuckNav">
      <nav class="offcanvas offcanvas-start" id="navbarNav" tabindex="-1" aria-labelledby="navbarNavLabel">
        <div class="offcanvas-header py-3">
          <h5 class="offcanvas-title" id="navbarNavLabel">Browse Vijayalaxmi sarees</h5>
          <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
...
include_once './common/navbar.php';
  ...
  <main class="content-wrapper">
    ...
    <section class="container">
      ...
      <!-- //main content -->
      <form action="insertsareessql.php" enctype="multipart/form-data" method="post">
  <fieldset >
    <h1>Entry Saree</h1>
    <!-- <div class="mb-3">
      <label for="disabledTextInput" class="form-label">saree _name</label>
      <input type="text" id="disabledTextInput" class="form-control" placeholder="saree name" name=sareename>
    </div> -->
    <div class="mb-3">
      <label for="disabledSelect" class="form-label">Saree Type</label>
      <select id="disabledSelect" class="form-select" name="sareestype">
        <option>Banarasi Saree</option>
        <option>Chanderi Saree</option>
        <option>Sambalpuri Saree</option>
        <option>Sambalpuri Saree</option>
        <option>Cotton Saree</option>
        <option>Net Saree</option>
        <option>Pochampally Saree</option>
        <option >Linen Saree</option>
      </select>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">saree MRP</label>
      <input type="text" id="disabledTextInput" class="form-control" placeholder="saree name" name="sareesmrp" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">saree price</label>
      <input type="text" id="disabledTextInput" class="form-control" placeholder="saree name" name="sareesprice" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">Saree _Quantity</label>
      <input type="text" id="disabledTextInput" class="form-control" placeholder="saree name" name="sareesquantity" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">img1</label>
      <input type="file" id="disabledTextInput" class="form-control" placeholder="saree name" name="img1" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">img2</label>
      <input type="file" id="disabledTextInput" class="form-control" placeholder="saree name" name="img2" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">img3</label>
      <input type="file" id="disabledTextInput" class="form-control" placeholder="saree name" name="img3" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">img4</label>
      <input type="file" id="disabledTextInput" class="form-control" placeholder="saree name" name="img4" required>
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">img5</label>
      <input type="file" id="disabledTextInput" class="form-control" placeholder="saree name" name="img5" required>
    </div>
...
<!-- Mirrored from cartzilla.createx.studio/shop-catalog-fashion.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 May 2024 18:42:26 GMT -->
