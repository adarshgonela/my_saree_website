...
<head>
  ...
  <!-- SEO Meta Tags -->
  <title>Vijayalaxmi sarees | Fashion Store - Catalog</title>
  ...
  <header class="navbar navbar-expand-lg navbar-sticky bg-body d-block z-fixed p-0" data-sticky-navbar="{&quot;offset&quot;: 500}">
    ...
    <div class="collapse navbar-stuck-hide" id="stuckNav">
      <nav class="offcanvas offcanvas-start" id="navbarNav" tabindex="-1" aria-labelledby="navbarNavLabel">
       ...
       <?php  include_once '../Admin/common/navbar.php' ?>
          ...
          <?php
            ...
            <div class="col-6 col-md-4 mb-2 mb-sm-3 mb-md-0">
              <div class="animate-underline hover-effect-opacity">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-flex bg-body-tertiary rounded p-3" href="shop-product-fashion.html?id=<?php echo $row['id']?>">
                    <div class="ratio" style="--cz-aspect-ratio: calc(308 / 274 * 100%)">
                      <img src="data:image/jpeg;base64,<?php echo base64_encode($row['img1']) ?>" alt="Image">
                    </div>
                  </a>
                ...
                <div class="nav mb-2">
                  <a class="nav-link animate-target min-w-0 text-dark-emphasis p-0" href="shop-product-fashion.php?id=<?php echo $row['id']?>">
                    <span class="text-truncate"><h3><?php echo $row['sareetype'] ?></h1></span>
                  </a>
                </div>
                <div class="h6 mb-2">₹<?php echo $row['sareesprice'] ?><del class="fs-sm fw-normal text-body-tertiary">₹<?php echo $row['sareesmrp'] ?></del></div>
                  ...
                  <div class="position-relative mb-3">
                    ...
                    <div class="hover-effect-target position-absolute start-0 bottom-0 w-100 z-2 opacity-0 pb-2 pb-sm-3 px-2 px-sm-3">
                      <div class="d-flex align-items-center justify-content-center gap-2 gap-xl-3 bg-body rounded-2 p-2">
                        ...
                        <div class="nav">
                          <a class="nav-link fs-xs text-body-tertiary py-1 px-2" href="shop-product-fashion.html">+1</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <!-- <div class="col-12 col-md-8 mb-2 mb-sm-3 mb-md-0">
                <div class="position-relative bg-body-tertiary text-center rounded-4 p-4 p-sm-5 py-md-4 py-xl-5">
                  ...
                  <!-- <a class="btn btn-sm btn-dark stretched-link" href="shop-product-fashion.html">Shop now</a> -->
            <!-- </div>
              </div> -->
      ...
      <div class="text-center pb-2 pb-md-3">
        <h2 class="pb-2 mb-1">
          <span class="animate-underline">
            <a class="animate-target text-dark-emphasis text-decoration-none" href="#!">Vijayalaxmi sarees</a>
          </span>
        </h2>
